...
Der Adapter wird in der nächsten Implementierungswelle gegen die offizielle Instagram-API verdrahtet. Bis dahin sind keine Live-Aktionen freigeschaltet.
