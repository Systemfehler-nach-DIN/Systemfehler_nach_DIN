...
Der Adapter wird in der nächsten Implementierungswelle gegen die offizielle Pinterest-API verdrahtet. Bis dahin sind keine Live-Aktionen freigeschaltet.
